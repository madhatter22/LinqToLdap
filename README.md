...
## Getting Started
Below you'll find the fastest way to get up and running with LINQ to LDAP.  There's also an examples project over at [GitHub](https://github.com/madhatter22/linqtoldap_examples) with a MVC and WPF example that connects to a live OpenLDAP server.  You can also reference the [Documentation](Documentation).
